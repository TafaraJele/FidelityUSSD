...
namespace Veneka.Module.TranzwareCompassPlusFIMI.CustomFormatter
{
    ...
    class FIMIMessageReply : Message
    {
        private readonly Message message;

        public FIMIMessageReply(Message message)
        {
        ...
        protected override void OnWriteStartEnvelope(XmlDictionaryWriter writer)
        {
            ...
            writer.WriteAttributeString("xmlns", "m", null, "http://schemas.datacontract.org/2004/07/Veneka.Module.TranzwareCompassPlusFIMI.FIMI");
